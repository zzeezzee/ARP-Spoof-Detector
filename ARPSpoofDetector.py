...
class Detector():
    ...
    def about(self):
        ...
        print("                                 |_|                                                             ")
        print("# ==============================================================================")
        print("# author         : Santosh Kumar Pradhan")
        print("# website        : https://techadmin.in")
        print("# linkedin       : https://www.linkedin.com/in/santoshp")
        print("# github         : https://github.com/santoshpradhan")
        print("# email          : kanhapradhan9999 < at > gmail[.]com")
        print("# description    :  ARP Spoofing  eden ARP Spoof Detector Scripti.")
        print("# version        : 1.0")
